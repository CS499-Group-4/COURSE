...
#——————————————————————————————————————————————————
        ...
        ToolTip(entry3, msg="Add file to system", delay=1.0)
        ToolTip(entry3, msg="Enter Assigned Class ID \nExample: CS 127", delay=1.0)
        #----------------------------------------------------------------------------------------------------------------
        ...
        ToolTip(entry4, msg="Add file to system", delay=1.0)
        ToolTip(entry4, msg="Enter Assigned Class ID \nExample: CS 232", delay=1.0)
        #----------------------------------------------------------------------------------------------------------------
        ...
        ToolTip(entry5, msg="Add file to system", delay=1.0)
        ToolTip(entry5, msg="Enter Assigned Class ID \nExample: CS 101", delay=1.0)
        #----------------------------------------------------------------------------------------------------------------
        ...
        ToolTip(entry6, msg="Add file to system", delay=1.0)
        ToolTip(entry6, msg="Enter Assigned Class ID \nExample: CS 128", delay=1.0)
        #----------------------------------------------------------------------------------------------------------------
